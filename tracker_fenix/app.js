    ...
    const weeklyAgenda = {
        ...
        3: [ // Miércoles
            { 
                ...
                script: `[GUION PARA GRABAR]\nTítulo en pantalla: La triste paradoja de la atracción 💔\n\n"¿Te has dado cuenta que la chica que no te interesa siempre está detrás de ti, pero la que te encanta te ignora? Esa es la paradoja de la atracción. A la que no te gusta, la tratas con indiferencia, y eso proyecta estatus y desapego. A la que te gusta, la persigues y te vuelves complaciente. Si quieres atraer a la que te gusta, tienes que tratarla como a la que no te importa. Entiende el juego descargando mi guía gratuita en mi bio."\n\n[COPIAR Y PEGAR EN DESCRIPCIÓN]\nDeja de intentar comprar su atención. 🛑\nLa neurociencia es clara: los humanos persiguen aquello que no pueden controlar fácilmente. Sé un reto.\n👉 Descarga GRATIS mi manual 'El Escáner Magnético' en el enlace de mi perfil y conviértete en el hombre que ellas buscan.\n#CaballeroModerno #Seduccion #PsicologiaDeAtraccion #HombreDeAltoValor #ComoLigar #Friendzone #DesarrolloPersonal`
            },
            {
                id: 't-wed-fb',
                text: 'Publicar Post en Facebook (Copiar y Pegar)',
                script: `La paradoja del amor moderno: La chica que no te interesa te busca, y la que te gusta te ignora. 💔\n\n¿Por qué? Porque a la que no te gusta la tratas sin miedo a perderla, lo que proyecta un estatus magnético. En cambio, a la que te gusta, la idealizas, te vuelves complaciente y aburrido.\n\nAprende a dominar el desapego y a proyectar alto estatus (incluso con la chica de tus sueños) en El Playbook:\n👉 ${linkVentas}\n\n---\n🎨 PROMPT IMAGEN (Midjourney/DALL-E):\n"A cinematic shot of a dark marble chessboard. A solitary black King piece stands tall and dominant, while white pawns are scattered blurred in the background. High contrast, elegant dark and gold color palette, photorealistic --ar 4:5"`
            },
        ...
        4: [ // Jueves
            { 
                ...
                script: `[GUION PARA GRABAR]\nTítulo en pantalla: El lenguaje corporal del 1% de los hombres ♟️\n\n"Tu lenguaje corporal habla antes que tú. Si estás encorvado, haces movimientos rápidos y nerviosos, y esquivas la mirada... le gritas 'inseguridad' a su subconsciente. Un Caballero Moderno del 1% ocupa su espacio. Se mueve lento y sin prisa. Mantiene el contacto visual. Esa calma proyecta un estatus brutal que ninguna frase para ligar puede igualar. Aprende los secretos de la atracción gratuita en el link de mi perfil."\n\n[COPIAR Y PEGAR EN DESCRIPCIÓN]\nEl 90% de la atracción es NO verbal. 🤫🔥\nSi tu cuerpo comunica miedo o ansiedad, no importa qué tan buen conversador seas. Tienes que dominar la primera impresión.\n👉 Descarga GRATIS mi manual 'El Escáner Magnético' en el enlace de mi perfil.\n#CaballeroModerno #LenguajeCorporal #Psicologia #Seduccion #AltoValor #Masculinidad #Confianza`
            },
            {
                id: 't-thu-fb',
                text: 'Publicar Post en Facebook (Copiar y Pegar)',
                script: `Tu lenguaje corporal grita tus inseguridades antes de que digas 'Hola'. 🤫🔥\n\nMoverte rápido, esquivar la mirada y encorvarte son señales subconscientes de debilidad que las mujeres detectan en 1 segundo.\n\nDescubre cómo hackear tu lenguaje no verbal y proyectar masculinidad inquebrantable en El Playbook del Conquistador:\n👉 ${linkVentas}\n\n---\n🎨 PROMPT IMAGEN (Midjourney/DALL-E):\n"A confident, well-dressed man walking powerfully through a busy modern lobby, looking straight ahead with intense focus, sharp suit, slow motion feel, cinematic, photorealistic --ar 4:5"`
            },
        ...
        5: [ // Viernes
            { 
                ...
                script: `[GUION PARA GRABAR]\nTítulo en pantalla: Por qué ser su amigo es el peor error 🚫\n\n"Creer que siendo su 'mejor amigo' y escuchando todos sus problemas sobre su ex te va a llevar a una relación... es la mayor mentira de Hollywood. Si la tratas como una amiga, te verá como una amiga. Tienes que polarizar. Muestra tu interés con elegancia. Es mejor recibir un 'no' temprano que perder 6 meses en la friendzone. Deja de mendigar y descarga mi guía gratuita para volverte un hombre magnético. Link en bio."\n\n[COPIAR Y PEGAR EN DESCRIPCIÓN]\nUn hombre de alto valor no es un terapeuta gratuito. 🛋️❌\nOcultar tus intenciones por miedo a asustarla es el boleto VIP hacia la Friendzone. \n👉 Aprende a comunicar tu estatus descargando GRATIS 'El Escáner Magnético' en el enlace de mi perfil.\n#CaballeroModerno #Friendzone #AtraerMujeres #Seduccion #AltoValor #ConsejosParaHombres #DesarrolloPersonal`
            },
            {
                id: 't-fri-fb',
                text: 'Publicar Post en Facebook (Copiar y Pegar)',
                script: `Deja de ser un Peón en un juego de Reyes ♟️👑\n\nLa mayoría de los hombres navegan las relaciones como peones: avanzan lento, son predecibles y solo intentan agradar. Un hombre de alto valor no reacciona a los movimientos de los demás; él controla su propio tablero.\n\nEmpieza a pensar como el Rey y conquista tus relaciones con El Playbook:\n👉 ${linkVentas}\n\n---\n🎨 PROMPT IMAGEN (Midjourney/DALL-E):\n"A sleek, cinematic close-up of a dark marble chessboard. A solitary black King piece stands tall and dominant, white pawns scattered. High contrast, elegant dark and gold color palette, photorealistic --ar 4:5"`
            },
